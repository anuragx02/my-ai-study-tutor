...
from backend.apps.core.views import AskView, ChatSessionDetailView, ChatSessionListView, OCRView, EquationOCRView
...
urlpatterns = [
    ...
    path("ocr/equation", EquationOCRView.as_view(), name="ai-ocr-equation"),
]
