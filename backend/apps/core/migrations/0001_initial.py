# Generated by Django 5.2.12 on 2026-04-21 18:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default='student', editable=False, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retrieval_confidence', models.FloatField(blank=True, null=True)),
                ('source_type', models.CharField(choices=[('none', 'None'), ('web', 'Web')], default='none', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
